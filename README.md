...
* **Source of Cropped Faces:** [**Hugging Face Datasets**](https://huggingface.co/datasets/amannagrawall002/croppedFaceDataset/blob/main/WIDER_val_cropped_faces.zip)
...
* **Source of CelebA Data:** [**Kaggle**](https://www.kaggle.com/datasets/jessicali9530/celeba-dataset)
...
* **Video Walkthrough:** [**Video Link of the W&B Dashboard**](YOUR_LOOM_VIDEO_LINK_HERE)
...
1.  **Download Source Data:**
    * Download the author-generated cropped faces from the [**Hugging Face Hub**](https://huggingface.co/datasets/amannagrawall002/croppedFaceDataset/blob/main/WIDER_val_cropped_faces.zip) and unzip it. Rename the folder to `wider_face_crops`.
    * Download the CelebA dataset from [**Kaggle**](https://www.kaggle.com/datasets/jessicali9530/celeba-dataset), unzip it, and place the `img_align_celeba` folder in the project root.
